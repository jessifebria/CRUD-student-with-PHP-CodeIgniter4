...
class Mahasiswa extends BaseController
{
	...
	public function save()
	{
		if (!$this->validate([
			...
			'notelp' => [
				'rules' => 'required|max_length[12]|numeric|numeric|regex_match[/^08/]',
				'errors' => [
					'required' => '{field} harus diisi.',
					'max_length' => '{field} maks 12 angka.',
					'numeric' => '{field} hanya boleh diisi angka',
					'regex_match' => '{field} harus diawali dengan 08'
				]
			],
			'kodepos' => [
	...
	public function update($id)
	{
		...
		if (!$this->validate([
			...
			'notelp' => [
				'rules' => 'required|max_length[12]|numeric|regex_match[/^08/]',
				'errors' => [
					'required' => '{field} harus diisi.',
					'max_length' => '{field} maks 12 angka.',
					'numeric' => '{field} hanya boleh diisi angka',
