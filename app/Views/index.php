...
<a href="/mahasiswa/create" style="position:absolute;top:20; right:50;" class="btn btn-success my-2 my-sm-0" class="btn btn-warning" role="button">
	Tambah Data</a>
	...
	<tbody>
		...
		foreach ($mahasiswa as $m) : ?>
			<tr align="center" height="40">
				...
				<td>
					<form action="/mahasiswa/<?= $m['id']; ?>" method="post" class="d-inline" id="formdelete">
						<?= csrf_field(); ?>
						<input type="hidden" name="_method" value="DELETE">
						<input id="deletenim" value="<?= $m['nim']; ?>" type=hidden>
						<button type="submit" class="btn btn-danger" id="submitdelete">&#128473;</button>
					</form>|
